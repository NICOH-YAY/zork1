;"Hollow House: copied from the Zork I source at the repo root by
...
<ROUTINE V-VERSION ("AUX" (CNT 17))
	<TELL "HOLLOW HOUSE|An interactive horror, built from the Zork I source|Zork I (c) Infocom; source released under the MIT license by Microsoft, 2025|Release ">
...
<ROUTINE V-COUNT ()
	 <COND (<EQUAL? ,PRSO ,BLESSINGS>
	 	<TELL "Well, for one, June is still up there. You can count on her." CR>)
	       (T
...
<COND (<N==? ,ZORK-NUMBER 3>
       <GLOBAL SWIMYUKS
	       <LTABLE 0 "The water is too cold, and much too still.">>)>
